...
\def\thesisauthor  {Kim Rostgaard Christensen (s084283)}
\def\thesistitle   {Requirements as test}
\def\thesissubtitle{Automatic generation of test from structured requirements}
